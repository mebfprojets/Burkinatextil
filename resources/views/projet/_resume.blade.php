...
<body>
    ...
    <table>
        <tr>
            ...
            <td>Date d'enregistrement : {{ format_date($projet->created_at) }}</td>
        </tr>
    </table>
       ...
       @if($projet->porteur->type_personne=='P')
        <table>
            ...
            <tr>
                ...
                <td>{{ getlibelle($projet->porteur->experience)  }}</td>
            </tr>
            <tr>
...
<tr>
    ...
    <td>Total</td>
    <td>
      {{ format_prix($projet->evaluation_financieres->sum('total_projet')) }}
    </td>
    <td>
